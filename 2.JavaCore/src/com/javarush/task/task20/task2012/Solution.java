...
public class Solution {
    ...
    public static void main(String[] args)throws IOException, ClassNotFoundException {
        OutputToConsole outPutConsole = new OutputToConsole(1);
        ObjectOutput objectOutput = new ObjectOutputStream(new FileOutputStream("b:\\1.txt"));
        outPutConsole.writeExternal(objectOutput);
        objectOutput.close();
        ObjectInput objectInput = new ObjectInputStream(new FileInputStream("b:\\1.txt"));
